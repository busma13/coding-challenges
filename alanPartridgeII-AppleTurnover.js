...
PREP
Parameters: A number or a string whos value is a valid integer number.
Returns: One of two strings: 'It's hotter than the sun!!' or 'Help yourself to a honeycomb Yorkie for the glovebox.'.
Examples: apple(5); // 'Help yourself to a honeycomb Yorkie for the glovebox.'
          apple('50'); // 'It's hotter than the sun!!'
Pseudo code: Convert x to a number.
             Square x.
             Compare that value to 1000.
             Return one of the two strings depending on the result.
*/
